  ...
  return (
    <div className="relative p-5 overflow-x-auto">
      <div className="flex items-center justify-between mb-11">
        <h1 className="text-5xl font-semibold text-white">List Banks</h1>
        <Link to="/banks/create" className="btn text-black bg-[#F9D949] hover:bg-[#F7C04A]">Create New</Link>
      </div>
        ...
        <table className="table w-full text-center">
          <thead>
            <tr>
              ...
              <th className="bg-[#144272] text-white">Nomor Rekening</th>
