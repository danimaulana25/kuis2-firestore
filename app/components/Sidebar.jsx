  ...
  return (
          ...
          <div className="px-2 py-3 h-fit rounded-xl bg-[#144272]">
            <ul className="space-y-2 font-medium rounded-xl">
              <li>
                <Link
                  to="/"
                  className={`flex items-center p-2  rounded-lg  hover:bg-[#A5D7E8]  text-[#EEEEEE] hover:text-slate-900 ${location.pathname === "/" && "bg-[#A5D7E8] text-slate-900"}`}
              ...
              <li>
                <Link
                  to="/vehicle"
                  className={`flex items-center p-2  rounded-lg  hover:bg-[#A5D7E8]  text-[#EEEEEE] hover:text-slate-900 ${location.pathname === "/vehicle" && "bg-[#A5D7E8] text-slate-900"}`}
                >
              ...
              <li>
                <Link
                  to="/brands"
                  className={`flex items-center p-2  rounded-lg  hover:bg-[#A5D7E8]  text-[#EEEEEE] hover:text-slate-900 ${location.pathname === "/brands" && "bg-[#A5D7E8] text-slate-900"}`}
                >
                  <svg
                    version="1.1"
                    id="svg2"
	...
	l329.088-329.089c29.633-32.787,26.469-80.075,0-108.843L670.618,203.787C625.179,147.074,527.354,103.175,506.438,100.615z"
              ...
              <li>
                <Link
                  to="/banks"
                  className={`flex items-center p-2  rounded-lg  hover:bg-[#A5D7E8]  text-[#EEEEEE] hover:text-slate-900 ${location.pathname === "/banks" && "bg-[#A5D7E8] text-slate-900"}`}
                >
                  <svg
                    version="1.0"
                    id="Layer_1"
		...
		C33.438,0.193,32.719,0,32,0s-1.438,0.193-2.076,0.581l-28,17c-1.533,0.931-2.26,2.77-1.775,4.497C0.632,23.806,2.206,25,4,25z
		 M32,9c2.762,0,5,2.238,5,5s-2.238,5-5,5s-5-2.238-5-5S29.238,9,32,9z"
              ...
              <li>
                <Link
                  to="/category"
                  className={`flex items-center p-2  rounded-lg  hover:bg-[#A5D7E8]  text-[#EEEEEE] hover:text-slate-900 ${location.pathname === "/category" && "bg-[#A5D7E8] text-slate-900"}`}
                >
                  <svg className="w-6 h-6 transition duration-75 " viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
